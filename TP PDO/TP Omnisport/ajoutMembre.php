...
if ($_POST) {
    ...
    if ($nom_licencie != "") {
        $req1 = $pdo->prepare("
        INSERT INTO licencie (nom_licencie, prenom, email, age, description_licencie, photo, password)
        VALUES (?, ?, ?, ?, ?, ?, ?)
        ");
        $req1->execute([$nom_licencie, $prenom, $email, $age, $description_licencie, $photo, $password]);
